...
for i in xrange(1, covarianceSteps+1):
	...
	with open(environmentTemplate + ".cfg", 'r') as f:
		...
		if "processError" in data[k]:
		    ...
		    data[k] = "measureOutputFileEMD = /data/hoe01h/oppt_devel/files/measureSamples4DOF/measureSamples" + environmentTemplate + "EMD" + str(i) + ".txt \n"
		elif "measureOutputFileTV" in data[k]:
		    data[k] = "measureOutputFileTV = /data/hoe01h/oppt_devel/files/measureSamples4DOF/measureSamples" + environmentTemplate + "TV" + postFix + str(i) + ".txt \n" 
