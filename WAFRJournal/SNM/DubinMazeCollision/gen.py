	    ...
	    with open(environmentTemplate + ".cfg", 'r') as f:
			...
			for k in xrange(len(data)):
				if "processError" in data[k]:
					...
					data[k] = "measureOutputFileEMD = /data/hoe01h/oppt_devel/files/measureSamplesDubin/measureSamplesDubinMazeCollisionEMD" + str(i) + ".txt \n"
				elif "measureOutputFileTV" in data[k]:
					data[k] = "measureOutputFileTV = /data/hoe01h/oppt_devel/files/measureSamplesDubin/measureSamplesDubinMazeCollisionTV" + str(i) + ".txt \n" 
