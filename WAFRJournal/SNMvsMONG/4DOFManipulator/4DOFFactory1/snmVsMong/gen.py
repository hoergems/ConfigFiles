...
for i in xrange(1, covarianceSteps+1):
	...
	with open(environmentTemplate + ".cfg", 'r') as f:
		...
		if "processError" in data[k]:
		    ...
		    trajectoryOutputFile = "/data/hoe01h/oppt_devel/files/trajectorySamples4DOFFactory1/trajectorySamples4DOFFactory1.txt"
		    data[k] = "outputFile = " + str(trajectoryOutputFile) + "\n"
		elif "measureOutputFileSNM" in data[k]:
		    data[k] = "measureOutputFileSNM = /data/hoe01h/oppt_devel/files/measureSamples4DOFFactory1/measureSamples4DOFFactory1" + str(i) + "_proc_" + str(i) + "_obsSNM.txt \n"
		elif "measureOutputFileMONG" in data[k]:
		    data[k] = "measureOutputFileMONG = /data/hoe01h/oppt_devel/files/measureSamples4DOFFactory1/measureSamples4DOFFactory1" + str(i) + "_proc_" + str(i) + "_obsMONG.txt \n"
