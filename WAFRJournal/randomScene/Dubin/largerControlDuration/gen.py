...
parser.add_argument('-pr', '--prefix', type=str, default="", help="World prefix")
...
robot = args.robot
robotExecName = "dubin"
worldPrefix = args.prefix
if not worldPrefix == "":
    worldPrefix = worldPrefix + "_"
environmentTemplate = worldPrefix + "maze_environment_random_" + robot + "_"
if robot == "4DOF":
    robotExecName = "robot"
    environmentTemplate = worldPrefix + "world_random_RobotImpl_"
...
for i in xrange(1, covarianceSteps + 1):
	...
	for j in xrange(len(data)):
		...
		data[j] = "logPath = /datastore/hoe01h/WAFRJournal/randomScene/" + robot + "/largerControlDuration/" + str(numObstacles) + "_obstacles/" + str(i) + " \n"
